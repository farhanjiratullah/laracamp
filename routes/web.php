...
// Midtrans routes
Route::get('/payment/success', [CheckoutController::class, 'midtransCallback'])->name('checkout.midtrans.get.callback');
Route::post('/payment/success', [CheckoutController::class, 'midtransCallback'])->name('checkout.midtrans.post.callback');
...
Route::middleware(['auth'])->group(function() {
    ...
    Route::prefix('admin/dashboard')->name('admin.')->middleware('ensureUserRole:admin')->group(function() {
        ...
        Route::resource('discounts', AdminDiscount::class);
